          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="form-group{{ $errors->has('kode_transaksi') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  <input id="kode_transaksi" type="text" class="form-control" name="kode_transaksi" value="{{ $kode }}"
                    required readonly="">
              ...
              <div class="form-group{{ $errors->has('tgl_pinjam') ? ' has-error' : '' }}">
                ...
                <div class="col-md-3">
                  <input id="tgl_pinjam" type="date" class="form-control" name="tgl_pinjam"
                    ...
                    @if(Auth::user()->level == 'user') readonly @endif>
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-info btn-secondary" data-toggle="modal"
                        data-target="#myModal"><b>Cari Buku</b> <span class="fa fa-search"></span></button>
                    </span>
                  </div>
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-warning btn-secondary" data-toggle="modal"
                        data-target="#myModal2"><b>Cari Anggota</b> <span class="fa fa-search"></span></button>
                    </span>
                  </div>
              ...
              <div class="form-group{{ $errors->has('anggota_id') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                  ...
                  <input id="anggota_id" type="hidden" name="anggota_id" value="{{ Auth::user()->anggota->id }}"
                    required readonly="">
